...
namespace Slate
{
    ...
    ///<summary>A Path defined out of BezierCurves</summary>
    ...
    public class BezierPath : Path
    {
        ...
        ///<summary>Get a uniform Vector3 position along the path at normalized length t.</summary>
        ...
        ///<summary>Get approximate Vector3 position between two control points at normalized t.</summary>
